...
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-M2QOWI6T.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-YJLIJ6KN.js";
import {
  index
} from "./chunk-V7LMNY5Y.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-5VJWR7B3.js";
import {
  useConfig
} from "./chunk-FRXALC63.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-IAGLXTHG.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-PRS7PAL6.js";
import {
  renderAdmin
} from "./chunk-RBMLDYD2.js";
import {
  useAIAvailability
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-VXIKFRE5.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-6TQCV6IA.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-PELVRLP3.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-FLZ3MHCJ.js");
        return {
...
var LocalePicker = () => {
  ...
  const sortedLocaleOptions = React13.useMemo(() => {
  ...
  return (0, import_jsx_runtime21.jsxs)(Span, {
    ...
    children: [
      ...
      (0, import_jsx_runtime21.jsx)(TooltipImpl, {
        ...
        children: React14.cloneElement(icon, {
          "aria-hidden": true,
          focusable: false
        })
      })
...
function __variableDynamicImportRuntime1__3(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-INPQBDHR.js");
    case "./translations/es.json":
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-4SQZBWFO.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-KLUULQ42.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-4DEUW3TS.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-W4ZJ5J7R.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-476Y6KI7.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-NIQRA6FO.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-VV2H3IDP.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-Y7N5VSDM.js");
          return {
...
//# sourceMappingURL=chunk-6M4ZAKEL.js.map
